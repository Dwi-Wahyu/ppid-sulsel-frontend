<script>
	...
	// Definisi data timeline dalam array
	const steps = [
		{
			n: '1',
			title: m['timeline.step_1_title'](),
			desc: m['timeline.step_1_desc'](),
			dur: m['timeline.step_1_duration'](),
			col: 'from-ppid-primary to-ppid-primary-light',
		...
		{
			n: '2',
			title: m['timeline.step_2_title'](),
			desc: m['timeline.step_2_desc'](),
			dur: m['timeline.step_2_duration'](),
			col: 'from-ppid-accent to-ppid-accent-light',
		...
		{
			n: '3',
			title: m['timeline.step_3_title'](),
			desc: m['timeline.step_3_desc'](),
			dur: m['timeline.step_3_duration'](),
			col: 'from-ppid-primary to-ppid-primary-light',
			icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12a7.5 7.5 0 1 1 15 0 7.5 7.5 0 0 1-15 0Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9" />'
		},
		{
			n: '4',
			title: m['timeline.step_4_title'](),
			desc: m['timeline.step_4_desc'](),
			dur: m['timeline.step_4_duration'](),
			col: 'from-ppid-accent to-ppid-accent-light',
...
>
	...
	<div class="relative z-10 container mx-auto px-4 sm:px-6 md:px-4">
		...
		<div class="mx-auto max-w-6xl">
			...
			<div class="mt-6 text-center md:mt-12" data-aos="zoom-in">
				<div
					class="inline-flex w-full flex-col items-center gap-3 rounded-2xl border border-ppid-accent/30 bg-white px-6 py-4 shadow sm:flex-row md:px-8 dark:border-ppid-accent/20 dark:bg-slate-800"
				>
					<h3 class="text-ppid-primary dark:text-white">{m['timeline.total_time']()}</h3>
					<h4 class="font-semibold text-ppid-text">{m['timeline.max_days']()}</h4>
				</div>
			</div>
		</div>
	</div>
