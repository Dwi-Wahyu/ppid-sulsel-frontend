			...
			{#if isLoading}
				<div class="space-y-8 animate-pulse">
					<div class="flex flex-col gap-4 md:flex-row md:items-center">
						<div class="flex-1">
							<div class="h-6 w-32 bg-gray-200 dark:bg-slate-800 rounded-full mb-2"></div>
							<div class="h-10 w-full bg-gray-200 dark:bg-slate-800 rounded-lg"></div>
						</div>
					</div>
					<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
						<div class="lg:col-span-2 h-[600px] bg-gray-200 dark:bg-slate-800 rounded-3xl"></div>
						<div class="h-96 bg-gray-200 dark:bg-slate-800 rounded-3xl"></div>
					</div>
				</div>
			{:else if error}
				<div class="rounded-3xl bg-white py-20 text-center dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
					...
					<div class="space-y-6">
						...
						<div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-xs dark:border-slate-800 dark:bg-slate-800">
							...
							<div class="flex gap-2">
								<button aria-label="Bagikan ke Facebook" class="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-600 transition-colors hover:bg-ppid-primary hover:text-white dark:bg-slate-900 dark:text-slate-400">
									<svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
								</button>
								<button aria-label="Bagikan ke Twitter/X" class="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-slate-600 transition-colors hover:bg-ppid-primary hover:text-white dark:bg-slate-900 dark:text-slate-400">
