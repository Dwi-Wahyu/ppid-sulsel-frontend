...
<div class="mb-4 flex items-center justify-between">
	...
	<a
		href="/opd/dokumen-publik/create"
		...
		{#if showFilters}
			...
			>
				...
				>
					...
					<!-- Status Filter -->
					<div>
						<h1 class="mb-1 block text-xs font-medium text-slate-700 dark:text-slate-300">
							Status Verifikasi
						</h1>
						<select
							name="verify"
							...
							>
								...
								<td class="px-6 py-4 text-right">
									<div class="flex items-center justify-end gap-2">
										<a
											title="Edit dokumen"
											href="/opd/dokumen-publik/edit/{info.id_informasi}"
